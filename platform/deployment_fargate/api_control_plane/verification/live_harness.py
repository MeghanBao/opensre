...
from platform.deployment_fargate.api_control_plane.verification.setup_task import SANDBOX_SERVICE
    ...
    def _run_for_tenant(
        ...
        result = self._run_task(
            ...
            [
                "python",
                "-m",
                "platform.deployment_fargate.api_control_plane.verification.setup_task",
                operation,
                "--home",
                "/workspace/home",
                "--organization-id",
