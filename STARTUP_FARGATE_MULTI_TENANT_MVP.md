...
## Complete tenant reconciliation
...
2. **AWS adapters:** existing-resource discovery, S3 Files resources/access points,
   ...
   digest enforcement.
3. **Images and S3 Files harness:** image dependencies, setup-task writer, task
   definition tests, and opt-in live-AWS isolation tests.
...
4. **Lifecycle reconciler:** provision/start/stop/status/delete, complete isolation
