"""Discovery and validation for AWS resources that the MVP intentionally reuses."""
...
class ExistingInfrastructureDiscovery:
    """Find existing networking, ECR, and encrypted S3 resources."""
