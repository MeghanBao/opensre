...
from gateway.control_plane.authorizer import BearerAuthorizer
...
def _api() -> tuple[ControlPlaneApi, _Lifecycle, _Runs]:
    ...
    return (
        ControlPlaneApi(
            lifecycle=lifecycle,
            runs=runs,
            bearer_authorizer=BearerAuthorizer(_CredentialStore(), _SecretReader()),
