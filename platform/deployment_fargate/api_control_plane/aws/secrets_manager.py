...
class TenantSecretsManagerAdapter:
    ...
    def ensure_secret_tags(self, secret_arn: str, tags: dict[str, str]) -> None:
        ...
        self._client.tag_resource(SecretId=secret_arn, Tags=iam_tags(tags))
