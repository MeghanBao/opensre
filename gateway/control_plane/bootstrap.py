"""Runtime and infrastructure bootstrap for the control-plane Lambda.
...
from gateway.control_plane.authorizer import AwsSecretsManagerReader, BearerAuthorizer
from gateway.control_plane.contracts import (
    AgentRunRepository,
    TenantApiCredentialRepository,
)
from gateway.control_plane.handler import ControlPlaneApi
from gateway.control_plane.lifecycle import LifecycleService
from gateway.control_plane.postgres_store import PostgresControlPlaneStore

_DEFAULT_LIFECYCLE_FACTORY = (
    "platform.deployment.fargate.lifecycle:create_lifecycle_service_from_environment"
)
_LIFECYCLE_ROUTES = (
...
_runtime_api: ControlPlaneApi | None = None
